...
## Overview
The data in this repository can be combined and analyzed to make sense of counties with high amounts of "unexplained excess deaths" during the pandemic, deaths that often point toward COVID-19 death undercounts. [This reporting recipe](https://www.muckrock.com/news/archives/2022/jan/06/how-to-use-uncounted-cdc-data/) aims to help you learn the origins of death records, why death data is important, and how to use it. 
